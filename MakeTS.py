...
VIDEO_SIZE_SD = "720x480"
VIDEO_SIZE_SD_SIDECUT = "720x480（サイドカット）"
ONESEG_SIZE_16_9 = "320x180 / 16:9"
ONESEG_SIZE_4_3 = "320x240 / 4:3"
ONESEG_SIZE_OPTIONS = [ONESEG_SIZE_16_9, ONESEG_SIZE_4_3]
# OneSeg PID layout closer to real MX-style ISDB-T examples.
# A dedicated PCR-only PID is generated by replacing null packets with
# adaptation-field-only PCR packets before TSDuck injects the OneSeg PMT.
MAIN_VIDEO_PID = 0x0111
ONESEG_PCR_PID = 0x0200
ONESEG_PCR_PERIOD_MS = 200
ONESEG_PMT_PIDS = {1: 0x1FC8, 2: 0x1FC9}
ONESEG_VIDEO_PIDS = {1: 0x0281, 2: 0x0381}
ONESEG_PRIMARY_AUDIO_PIDS = {1: 0x0283, 2: 0x0383}
ONESEG_SECONDARY_AUDIO_PIDS = {1: 0x0284, 2: 0x0384}
ONESEG_VIDEO_COMPONENT_TAG = "0x81"
ONESEG_PRIMARY_AUDIO_COMPONENT_TAG = "0x83"
ONESEG_SECONDARY_AUDIO_COMPONENT_TAG = "0x84"


VIDEO_FILE_PATTERN = "*.mp4 *.mov *.mkv *.avi *.m2ts *.ts *.mpg *.mpeg *.wmv *.flv *.webm"
...
UI_TEXT_KEYS = [
    ...
    "OneSeg 1",
    "OneSeg 2",
    "Use main channel video",
    "Use OneSeg 1 video",
    "Use custom OneSeg video",
    "Use main channel audio",
    "Use OneSeg 1 audio",
    "Use custom OneSeg audio",
    "Use main channel EIT",
    "Use OneSeg 1 EIT",
    "Use custom OneSeg EIT",
    "OneSeg Video file",
    "OneSeg Audio file",
    "OneSeg Secondary Audio file",
    "OneSeg Resolution",
    "OneSeg Video Bitrate",
    "OneSeg Audio Bitrate",
    "OneSeg Secondary Audio Bitrate",
    "TS ID",
    "Original NW ID",
    "Network ID",
    "Remote Key ID",
...
BUILTIN_JA_TRANSLATIONS = {
    ...
    "Service ID": "サービスID",
    "Service ID 1": "サービスID 1",
    "Service ID 2": "サービスID 2",
    "Service ID 3": "サービスID 3",
    "OneSeg Service ID": "ワンセグサービスID",
    "OneSeg Service ID 1": "ワンセグサービスID 1",
    "OneSeg Service ID 2": "ワンセグサービスID 2",
    "OneSeg Streams": "ワンセグストリーム",
    "OneSeg 1": "ワンセグ1",
    "OneSeg 2": "ワンセグ2",
    "Use main channel video": "メインチャンネルと同じ映像を使う",
    "Use OneSeg 1 video": "ワンセグ1と同じ映像を使う",
    "Use custom OneSeg video": "個別映像を使う",
    "Use main channel audio": "メインチャンネルと同じ音声を使う",
    "Use OneSeg 1 audio": "ワンセグ1と同じ音声を使う",
    "Use custom OneSeg audio": "個別音声を使う",
    "Use main channel EIT": "メインチャンネルと同じEITを使う",
    "Use OneSeg 1 EIT": "ワンセグ1と同じEITを使う",
    "Use custom OneSeg EIT": "個別EITを使う",
    "OneSeg Video file": "ワンセグ映像ファイル",
    "OneSeg Audio file": "ワンセグ主音声ファイル",
    "OneSeg Secondary Audio file": "ワンセグ副音声ファイル",
    "OneSeg Resolution": "ワンセグ解像度",
    "OneSeg Video Bitrate": "ワンセグ映像ビットレート",
    "OneSeg Audio Bitrate": "ワンセグ主音声ビットレート",
    "OneSeg Secondary Audio Bitrate": "ワンセグ副音声ビットレート",
    "TS ID": "TS ID",
    ...
    "Service 3": "サービス3",
    "OneSeg": "ワンセグ",
    "OneSeg 1 Name": "ワンセグ1名",
    "OneSeg 2 Name": "ワンセグ2名",
...
class MakeTSGui(tk.Tk):
    ...
    def init_vars(self):
        ...
        self.service_name_1seg_1 = tk.StringVar(value="ＳＢＨ筑波携帯１")
        self.service_name_1seg_2 = tk.StringVar(value="ＳＢＨ筑波携帯２")
        # Backward-compatible alias for older parts/imported settings.
        self.service_name_1seg = self.service_name_1seg_1

        self.service_id_1 = tk.StringVar(value="0x6238")
        self.service_id_2 = tk.StringVar(value="0x6239")
        self.service_id_3 = tk.StringVar(value="0x623A")
        # Backward-compatible alias for older parts/imported settings.
        self.service_id = self.service_id_1
        self.oneseg_service_id_1 = tk.StringVar(value="0x63B8")
        self.oneseg_service_id_2 = tk.StringVar(value="0x69B9")
        # Backward-compatible alias for the first OneSeg service.
        self.oneseg_service_id = self.oneseg_service_id_1

        self.oneseg_use_main_video_1 = tk.StringVar(value="on")
        self.oneseg_video_mode_1 = tk.StringVar(value="main")
        self.oneseg_video_path_1 = tk.StringVar(value="")
        self.oneseg_use_main_audio_1 = tk.StringVar(value="on")
        self.oneseg_audio_mode_1 = tk.StringVar(value="main")
        self.oneseg_audio_path_1 = tk.StringVar(value="")
        self.oneseg_secondary_audio_path_1 = tk.StringVar(value="")
        self.oneseg_resolution_1 = tk.StringVar(value=ONESEG_SIZE_16_9)
        self.oneseg_video_bitrate_1 = tk.StringVar(value="180k")
        self.oneseg_audio_bitrate_1 = tk.StringVar(value="48k")
        self.oneseg_secondary_audio_bitrate_1 = tk.StringVar(value="48k")
        self.oneseg_eit_mode_1 = tk.StringVar(value="main")
        # Backward-compatible name for older code paths; the UI now uses oneseg_eit_mode_1.
        self.oneseg_use_main_eit_1 = tk.StringVar(value="on")
        self.oneseg_event_id_1 = tk.StringVar(value="0x0001")
        self.oneseg_event_name_1 = tk.StringVar(value="おはよう天気")
        self.oneseg_event_text_1 = tk.StringVar(value="天気情報")
        self.oneseg_event_start_time_1 = tk.StringVar(value="2026-03-30 05:00:00")
        self.oneseg_event_duration_1 = tk.StringVar(value="00:15:00")
        self.oneseg_event_language_1 = tk.StringVar(value="Japanese (jpn)")
        self.oneseg_event_running_status_1 = tk.StringVar(value="running")
        self.oneseg_genre_1 = tk.StringVar(value="News / Reports (0x0/0x0)")

        self.oneseg_use_main_video_2 = tk.StringVar(value="on")
        self.oneseg_video_mode_2 = tk.StringVar(value="oneseg1")
        self.oneseg_video_path_2 = tk.StringVar(value="")
        self.oneseg_use_main_audio_2 = tk.StringVar(value="on")
        self.oneseg_audio_mode_2 = tk.StringVar(value="oneseg1")
        self.oneseg_audio_path_2 = tk.StringVar(value="")
        self.oneseg_secondary_audio_path_2 = tk.StringVar(value="")
        self.oneseg_resolution_2 = tk.StringVar(value=ONESEG_SIZE_16_9)
        self.oneseg_video_bitrate_2 = tk.StringVar(value="180k")
        self.oneseg_audio_bitrate_2 = tk.StringVar(value="48k")
        self.oneseg_secondary_audio_bitrate_2 = tk.StringVar(value="48k")
        self.oneseg_eit_mode_2 = tk.StringVar(value="main")
        # Backward-compatible name for older code paths; the UI now uses oneseg_eit_mode_2.
        self.oneseg_use_main_eit_2 = tk.StringVar(value="on")
        self.oneseg_event_id_2 = tk.StringVar(value="0x0001")
        self.oneseg_event_name_2 = tk.StringVar(value="おはよう天気")
        self.oneseg_event_text_2 = tk.StringVar(value="天気情報")
        self.oneseg_event_start_time_2 = tk.StringVar(value="2026-03-30 05:00:00")
        self.oneseg_event_duration_2 = tk.StringVar(value="00:15:00")
        self.oneseg_event_language_2 = tk.StringVar(value="Japanese (jpn)")
        self.oneseg_event_running_status_2 = tk.StringVar(value="running")
        self.oneseg_genre_2 = tk.StringVar(value="News / Reports (0x0/0x0)")

        # Indexed OneSeg variable table. This keeps the public variable names above
        # for compatibility, while letting the rest of the code avoid one-off
        # branches for OneSeg 1 and OneSeg 2.
        self.oneseg_vars = {
            1: {
                "service_id": self.oneseg_service_id_1,
                "name": self.service_name_1seg_1,
                "video_mode": self.oneseg_video_mode_1,
                "video_path": self.oneseg_video_path_1,
                "audio_mode": self.oneseg_audio_mode_1,
                "audio_path": self.oneseg_audio_path_1,
                "secondary_audio_path": self.oneseg_secondary_audio_path_1,
                "resolution": self.oneseg_resolution_1,
                "video_bitrate": self.oneseg_video_bitrate_1,
                "audio_bitrate": self.oneseg_audio_bitrate_1,
                "secondary_audio_bitrate": self.oneseg_secondary_audio_bitrate_1,
                "eit_mode": self.oneseg_eit_mode_1,
                "use_main_eit": self.oneseg_use_main_eit_1,
                "event_id": self.oneseg_event_id_1,
                "event_name": self.oneseg_event_name_1,
                "event_text": self.oneseg_event_text_1,
                "start_time": self.oneseg_event_start_time_1,
                "duration": self.oneseg_event_duration_1,
                "language": self.oneseg_event_language_1,
                "running_status": self.oneseg_event_running_status_1,
                "genre": self.oneseg_genre_1,
            },
            2: {
                "service_id": self.oneseg_service_id_2,
                "name": self.service_name_1seg_2,
                "video_mode": self.oneseg_video_mode_2,
                "video_path": self.oneseg_video_path_2,
                "audio_mode": self.oneseg_audio_mode_2,
                "audio_path": self.oneseg_audio_path_2,
                "secondary_audio_path": self.oneseg_secondary_audio_path_2,
                "resolution": self.oneseg_resolution_2,
                "video_bitrate": self.oneseg_video_bitrate_2,
                "audio_bitrate": self.oneseg_audio_bitrate_2,
                "secondary_audio_bitrate": self.oneseg_secondary_audio_bitrate_2,
                "eit_mode": self.oneseg_eit_mode_2,
                "use_main_eit": self.oneseg_use_main_eit_2,
                "event_id": self.oneseg_event_id_2,
                "event_name": self.oneseg_event_name_2,
                "event_text": self.oneseg_event_text_2,
                "start_time": self.oneseg_event_start_time_2,
                "duration": self.oneseg_event_duration_2,
                "language": self.oneseg_event_language_2,
                "running_status": self.oneseg_event_running_status_2,
                "genre": self.oneseg_genre_2,
            },
        }
    ...
    def bind_var_events(self):
        ...
        self.oneseg_video_mode_1.trace_add("write", self.on_oneseg_video_source_changed)
        self.oneseg_video_mode_2.trace_add("write", self.on_oneseg_video_source_changed)
        self.oneseg_audio_mode_1.trace_add("write", self.on_oneseg_audio_source_changed)
        self.oneseg_audio_mode_2.trace_add("write", self.on_oneseg_audio_source_changed)
        self.oneseg_eit_mode_1.trace_add("write", self.on_oneseg_eit_source_changed)
        self.oneseg_eit_mode_2.trace_add("write", self.on_oneseg_eit_source_changed)
    ...
    def on_video_size_changed(self, *_):
        if self.is_sd_output_size():
            self.video_bitrate.set("6400k")
            self.video_maxrate.set("7000k")
            self.video_bufsize.set("3200k")
            if self.is_sd_sidecut_size() and self.output_aspect.get() != "4:3":
                self.output_aspect.set("4:3")
            return
    ...
    def set_widget_group_state(self, widgets, locked=False):
        for item in widgets:
            widget, normal_state = item if isinstance(item, tuple) else (item, "normal")
            try:
                widget.configure(state="disabled" if locked else normal_state)
            except tk.TclError:
                pass

    def on_oneseg_video_source_changed(self, *_):
        self.update_oneseg_video_state()

    def update_oneseg_video_state(self):
        for mode_var, file_widgets, setting_widgets in getattr(self, "oneseg_video_controls", []):
            mode = mode_var.get()
            self.set_widget_group_state(file_widgets, locked=(mode != "custom"))
            self.set_widget_group_state(setting_widgets, locked=(mode == "oneseg1"))

    def on_oneseg_audio_source_changed(self, *_):
        self.update_oneseg_audio_state()

    def update_oneseg_audio_state(self):
        for mode_var, widgets in getattr(self, "oneseg_audio_controls", []):
            self.set_widget_group_state(widgets, locked=(mode_var.get() != "custom"))

    def on_oneseg_eit_source_changed(self, *_):
        self.update_oneseg_eit_state()

    def update_oneseg_eit_state(self):
        for mode_var, widgets in getattr(self, "oneseg_eit_controls", []):
            # EIT fields are editable only in the custom-input mode.
            self.set_widget_group_state(widgets, locked=(mode_var.get() != "custom"))
    ...
    def file_entry_row(self, parent, row, label, variable, command, width=52):
        ...
        self.bind_input_context_menu(entry)
        browse = ttk.Button(parent, text=self.t("Browse"), width=10, command=command)
    ...
    def build_oneseg_stream_frame(self, parent, title, index, video_mode_var, video_var, resolution_var, video_bitrate_var, video_command, bg):
        ...
        mode_frame = ttk.Frame(grid)
        mode_frame.grid(row=0, column=1, sticky="w", pady=(0, 8))
        video_mode_options = [("Use main channel video", "main")]
        if index == 2:
            video_mode_options.append(("Use OneSeg 1 video", "oneseg1"))
        video_mode_options.append(("Use custom OneSeg video", "custom"))

        for row_index, (label, value) in enumerate(video_mode_options):
            tk.Radiobutton(
                mode_frame,
                text=self.t(label),
                ...
                bd=0,
                anchor="w",
                command=self.update_oneseg_video_state,
            ).grid(row=row_index, column=0, sticky="w", pady=(0, 2))

        video_entry, video_browse = self.file_entry_row(grid, 1, "OneSeg Video file", video_var, video_command)
        resolution_combo = self.combo_row(grid, 2, "OneSeg Resolution", resolution_var, ONESEG_SIZE_OPTIONS)
        video_bitrate_entry = self.entry_row(grid, 3, "OneSeg Video Bitrate", video_bitrate_var)
        grid.columnconfigure(1, weight=1)

        self.oneseg_video_controls.append((
            video_mode_var,
            [(video_entry, "normal"), (video_browse, "normal")],
    ...
    def build_oneseg_audio_frame(
        ...
        audio_command,
        secondary_audio_var,
        secondary_audio_bitrate_var,
        secondary_audio_command,
        bg,
    ):
        group = ttk.LabelFrame(parent, text=title)
        group.pack(fill="x", anchor="n", padx=8, pady=(8, 4))
        ...
        audio_mode_options = [("Use main channel audio", "main")]
        if index == 2:
            audio_mode_options.append(("Use OneSeg 1 audio", "oneseg1"))
        audio_mode_options.append(("Use custom OneSeg audio", "custom"))

        for row_index, (label, value) in enumerate(audio_mode_options):
            tk.Radiobutton(
                mode_frame,
                text=self.t(label),
                variable=audio_mode_var,
                value=value,
                bg=bg,
                activebackground=bg,
                highlightthickness=0,
                bd=0,
                anchor="w",
                command=self.update_oneseg_audio_state,
            ).grid(row=row_index, column=0, sticky="w", pady=(0, 2))

        primary = ttk.LabelFrame(grid, text=self.t("Primary Audio"))
        primary.grid(row=1, column=0, columnspan=3, sticky="ew", pady=(0, 8))
        primary_grid = ttk.Frame(primary)
        primary_grid.pack(fill="x", padx=8, pady=8)
        audio_entry, audio_browse = self.file_entry_row(primary_grid, 0, "OneSeg Audio file", audio_var, audio_command)
        audio_bitrate_combo = self.combo_row(primary_grid, 1, "OneSeg Audio Bitrate", audio_bitrate_var, AUDIO_BITRATES)
        primary_grid.columnconfigure(1, weight=1)

        secondary = ttk.LabelFrame(grid, text=self.t("Secondary Audio"))
        secondary.grid(row=2, column=0, columnspan=3, sticky="ew")
        secondary_grid = ttk.Frame(secondary)
        secondary_grid.pack(fill="x", padx=8, pady=8)
        secondary_audio_entry, secondary_audio_browse = self.file_entry_row(
            secondary_grid,
            0,
            "OneSeg Secondary Audio file",
            secondary_audio_var,
        ...
        secondary_bitrate_combo = self.combo_row(
            secondary_grid,
            1,
            "OneSeg Secondary Audio Bitrate",
            secondary_audio_bitrate_var,
        ...
        self.oneseg_audio_controls.append((
            audio_mode_var,
            [
                (audio_entry, "normal"),
                (audio_browse, "normal"),
                (audio_bitrate_combo, "readonly"),
                (secondary_audio_entry, "normal"),
                (secondary_audio_browse, "normal"),
                (secondary_bitrate_combo, "readonly"),
            ],
        ))
    ...
    def build_ts_info_tab(self):
        ...
        ts_rows = [
            ...
            ("Service ID 1", self.service_id_1),
            ("Service ID 2", self.service_id_2),
            ("Service ID 3", self.service_id_3),
            ("OneSeg Service ID 1", self.oneseg_service_id_1),
            ("OneSeg Service ID 2", self.oneseg_service_id_2),
    ...
    def build_service_names_section(self, parent):
        ...
        for index, (label, variable) in enumerate(
            [
                ...
                ("OneSeg 1 Name", self.service_name_1seg_1),
                ("OneSeg 2 Name", self.service_name_1seg_2),
            ],
            start=1,
        ):
            self.entry_row(grid, index, label, variable)
    ...
    def build_oneseg_eit_frame(
        ...
        eit_mode_options = [("Use main channel EIT", "main")]
        if index == 2:
            eit_mode_options.append(("Use OneSeg 1 EIT", "oneseg1"))
        eit_mode_options.append(("Use custom OneSeg EIT", "custom"))

        for row_index, (label, value) in enumerate(eit_mode_options):
            tk.Radiobutton(
                mode_frame,
                text=self.t(label),
                variable=eit_mode_var,
                value=value,
                bg=bg,
                activebackground=bg,
                highlightthickness=0,
                bd=0,
                anchor="w",
                command=self.update_oneseg_eit_state,
            ).grid(row=row_index, column=0, sticky="w", pady=(0, 2))

        event_id_entry = self.entry_row(grid, 1, "Event ID", event_id_var)
        event_name_entry = self.entry_row(grid, 2, "Event Name", event_name_var)
        description_text = self.text_row(grid, 3, "Description", event_text_var.get(), height=3)
        self.oneseg_description_texts[index] = description_text
        start_time_entry = self.entry_row(grid, 4, "Start Time", start_time_var)
        duration_entry = self.entry_row(grid, 5, "Duration", duration_var)
        language_combo = self.combo_row(grid, 6, "Language", language_var, LANGUAGE_OPTIONS)
        running_combo = self.combo_row(grid, 7, "Running Status", running_status_var, ["running", "not-running", "pausing", "undefined"])
        genre_combo = self.combo_row(grid, 8, "Genre", genre_var, GENRE_OPTIONS)
        grid.columnconfigure(1, weight=1)

        self.oneseg_eit_controls.append((
            eit_mode_var,
            [
                (event_id_entry, "normal"),
                (event_name_entry, "normal"),
                (description_text, "normal"),
                (start_time_entry, "normal"),
                (duration_entry, "normal"),
                (language_combo, "readonly"),
                (running_combo, "readonly"),
                (genre_combo, "readonly"),
            ],
        ))
    ...
    def import_sdt_xml(self, root):
        ...
        for service in self.xml_elements(sdt, "service"):
            ...
            if service_type.lower() == "0xc0":
                oneseg_services.append((service_id, service_name))
            else:
                full_services.append((service_id, service_name, service_type))

        full_service_id_vars = [self.service_id_1, self.service_id_2, self.service_id_3]
        full_service_name_vars = [self.service_name_1, self.service_name_2, self.service_name_3]
        for index, (service_id, service_name, service_type) in enumerate(full_services[:3]):
            self.set_if_present(full_service_id_vars[index], service_id)
            self.set_if_present(full_service_name_vars[index], service_name)
            if index == 0:
                self.set_if_present(self.service_type, service_type)

        if oneseg_services:
            self.set_if_present(self.oneseg_service_id_1, oneseg_services[0][0])
            self.set_if_present(self.service_name_1seg_1, oneseg_services[0][1])
        if len(oneseg_services) > 1:
            self.set_if_present(self.oneseg_service_id_2, oneseg_services[1][0])
            self.set_if_present(self.service_name_1seg_2, oneseg_services[1][1])
    ...
    def import_nit_service_list(self, nit):
        ...
        for service in self.xml_elements(nit, "service"):
            ...
            if service_type == "0xc0":
                oneseg_ids.append(service_id)
            elif service_type == "0x01":
                full_service_ids.append(service_id)

        full_service_id_vars = [self.service_id_1, self.service_id_2, self.service_id_3]
        for index, service_id in enumerate(full_service_ids[:3]):
            full_service_id_vars[index].set(service_id)
        if oneseg_ids:
            self.oneseg_service_id_1.set(oneseg_ids[0])
        if len(oneseg_ids) > 1:
            self.oneseg_service_id_2.set(oneseg_ids[1])
    ...
    def select_oneseg_video(self, index):
        self.select_oneseg_file(index, "video_path", f"{self.t('OneSeg')} {index} {self.t('Video')}", self.t("Video files"), VIDEO_FILE_PATTERN)

    def select_oneseg_audio(self, index):
        self.select_oneseg_file(index, "audio_path", f"{self.t('OneSeg')} {index} {self.t('Primary Audio')}", self.t("Audio files"), AUDIO_FILE_PATTERN)

    def select_oneseg_secondary_audio(self, index):
        self.select_oneseg_file(index, "secondary_audio_path", f"{self.t('OneSeg')} {index} {self.t('Secondary Audio')}", self.t("Audio files"), AUDIO_FILE_PATTERN)

    def select_oneseg_file(self, index, var_name, title, type_label, pattern):
        path = self.ask_file(title, [(type_label, pattern), (self.t("All files"), "*.*")])
        if path:
    ...
    def add_files(self):
        paths = filedialog.askopenfilenames(
            ...
            filetypes=[
                (self.t("Video files"), VIDEO_FILE_PATTERN),
                (self.t("All files"), "*.*"),
            ],
        )
        for path in paths:
    ...
    def is_sd_output_size(self):
        return self.video_size.get() in (VIDEO_SIZE_SD, VIDEO_SIZE_SD_SIDECUT)

    def is_sd_sidecut_size(self):
        return self.video_size.get() == VIDEO_SIZE_SD_SIDECUT

    def video_size_key(self):
        return VIDEO_SIZE_SD if self.is_sd_output_size() else self.video_size.get()

    def output_height_value(self):
        if self.is_sd_output_size():
            return 480
        try:
            return int(self.video_size.get().split("x", 1)[1])
        except Exception:
            return 1080

    @staticmethod
    def color_standard(label):
        if label == "BT.709":
            return {
                "label": "BT.709",
                "matrix_z": "709",
    ...
    def output_standard(self):
        return self.color_standard("BT.709" if self.output_height_value() >= 720 else "BT.601")

    def input_height_value(self, video_info):
        try:
            return int(video_info.get("height", 0))
        except Exception:
            return 0

    def resolution_based_sdr_standard(self, video_info):
        # For ordinary SDR sources, decide BT.709 / BT.601 from the input resolution.
        # HD and higher sources are treated as BT.709. SD sources are treated as BT.601.
        label = "BT.709" if self.input_height_value(video_info) >= 720 else "BT.601"
        return {key: self.color_standard(label)[key] for key in ("label", "matrix_z", "primaries_z", "transfer_z", "range_z")}

    def fallback_input_standard(self, video_info):
        if self.is_hdr_source(video_info):
            # Keep the existing HLG/PQ path first. If ffprobe does not provide
            # complete HDR color metadata, assume BT.2020 primaries/matrix for HDR.
            return {
                "label": "BT.2020 HDR fallback",
                "matrix_z": "2020_ncl",
                "primaries_z": "2020",
                "transfer_z": "arib-std-b67",
                "range_z": "limited",
            }
        return self.resolution_based_sdr_standard(video_info)
    ...
    def input_standard(self, video_info):
        ...
        is_hdr = self.is_hdr_source(video_info)
        ...
        if is_hdr:
            # HDR metadata wins. This preserves the existing HLG/PQ tone-map path.
            ...
            decision = "HDR transfer priority"
        else:
            # For full-seg SDR conversion, use input resolution as the source colorimetry rule:
            #   input height >= 720 -> BT.709
            #   input height <  720 -> BT.601
            # This avoids accidental BT.2020 SDR handling when the target is normal SDR MPEG-2 TS.
            sdr = self.resolution_based_sdr_standard(video_info)
            matrix_z = sdr["matrix_z"]
            primaries_z = sdr["primaries_z"]
            transfer_z = sdr["transfer_z"]
            decision = f"SDR input resolution -> {sdr['label']}"

        return {
            "matrix_z": matrix_z,
            "primaries_z": primaries_z,
    ...
    @staticmethod
    def normalized_color_name(value):
        return str(value or "").strip().lower().replace("_", "-")

    def is_hdr_source(self, video_info):
        transfer = self.normalized_color_name(video_info.get("color_transfer"))

        # iPhone HDR / HLG often appears as arib-std-b67.
        # PQ / HDR10 / Dolby Vision-compatible streams may appear as smpte2084.
        # Do not treat BT.2020 alone as HDR because SDR BT.2020 material can exist.
        return transfer in ("arib-std-b67", "hlg", "smpte2084", "pq")

    def color_process_label(self, video_info):
        if self.is_hdr_source(video_info):
            transfer = self.normalized_color_name(video_info.get("color_transfer"))
            if transfer in ("arib-std-b67", "hlg"):
                return "HDR HLG -> SDR tone-map"
            if transfer in ("smpte2084", "pq"):
                return "HDR PQ -> SDR tone-map"
            return "HDR -> SDR tone-map"
        return "SDR resolution-based BT.709/BT.601 conversion"

    # ------------------------------------------------------------------ ffmpeg

    def target_size_for_filter(self):
        return ("720", "486") if self.is_sd_output_size() else tuple(self.video_size.get().split("x"))
    ...
    def sar(self):
        return {
            ...
            ("1280x720", "16:9"): "1/1",
            ("1280x720", "4:3"): "3/4",
            (VIDEO_SIZE_SD, "16:9"): "32/27",
            (VIDEO_SIZE_SD, "4:3"): "8/9",
        }.get((self.video_size_key(), self.output_aspect.get()), "1/1")
    ...
    def color_filter_parts(self, video_info, width, height, dst):
        ...
        if self.is_hdr_source(video_info):
            return [
                (
                    "zscale="
                    f"w={width}:h={height}:"
                    f"matrixin={src['matrix_z']}:"
                    f"primariesin={src['primaries_z']}:"
                    f"transferin={src['transfer_z']}:"
                ...
                (
                    "zscale="
                    f"matrix={dst['matrix_z']}:"
                    f"primaries={dst['primaries_z']}:"
                    f"transfer={dst['transfer_z']}:"
                    f"range={dst['range_z']}"
                ),
                "format=yuv420p",
            ]
    ...
    def video_filter(self, video_info):
        ...
        if self.is_sd_sidecut_size():
            # 1920x1080 -> center-crop 1440x1080 -> blacken 15px L/R -> SD path.
            parts.extend([
                "crop=1440:1080:240:0",
                "drawbox=x=0:y=0:w=15:h=ih:color=black@1:t=fill",
                "drawbox=x=iw-15:y=0:w=15:h=ih:color=black@1:t=fill",
            ])
        elif self.is_sd_output_size():
            parts.extend([
                "drawbox=x=0:y=0:w=4:h=ih:color=black@1:t=fill",
                "drawbox=x=iw-4:y=0:w=4:h=ih:color=black@1:t=fill",
            ])

        parts.extend(self.color_filter_parts(video_info, width, height, dst))
    ...
    def oneseg_resolution_dimensions(self, value):
        text = str(value or "").strip()
        if text.startswith("320x240"):
            return "320", "240"
        return "320", "180"

    def oneseg_output_standard(self):
        # OneSeg QVGA is treated as SD colorimetry for the generated SDR stream.
        return self.color_standard("BT.601")

    def oneseg_video_filter(self, video_info, resolution):
        width, height = self.oneseg_resolution_dimensions(resolution)
        dst = self.oneseg_output_standard()
        parts = self.color_filter_parts(video_info, width, height, dst)
        parts.extend(["fps=15", "setsar=1/1", "format=yuv420p", self.setparams_filter(dst)])
        return ",".join(parts)

    @staticmethod
    def scaled_bitrate(value, factor, default):
        ...
        kbps = number * (1000 if unit == "m" else 1)
        scaled = max(1, int(round(kbps * factor)))
        return f"{scaled}k"

    def oneseg_service_rows(self):
        keys = (
            "service_id", "name", "video_mode", "video_path", "audio_mode",
            "audio_path", "secondary_audio_path", "resolution", "video_bitrate",
            "audio_bitrate", "secondary_audio_bitrate",
        )
        return tuple((index, *(self.oneseg_vars[index][key] for key in keys)) for index in (1, 2))

    def oneseg_is_active(self, sid_text, video_mode_var, video_var):
        video_mode = video_mode_var.get()
        return bool(str(sid_text or "").strip() and (video_mode in ("main", "oneseg1") or video_var.get().strip()))

    def oneseg_sid_entries(self):
        # Keep SI tables in sync with the actual OneSeg programs/PMTs.
        # The simplified UI can let OneSeg 2 share OneSeg 1 streams, so the
        # safest source of truth is the encode configuration, not only SID text.
        entries = []
        for service in self.oneseg_encode_configs():
            entries.append({
                "index": service["index"],
                "sid": service["sid"],
                "sid_number": service["sid_number"],
                "name": service["name"],
            })
        return entries

    def oneseg_eit_entries(self):
        entries = []
        for entry in self.oneseg_sid_entries():
            index = entry["index"]
            mode = self.oneseg_eit_mode_var(index).get()
            entries.append({
                **entry,
                "eit_mode": mode,
                "use_main_eit": mode == "main",
                "use_oneseg1_eit": index == 2 and mode == "oneseg1",
                "event_data": self.oneseg_eit_event_data(index),
            })
        return entries

    def oneseg_eit_mode_var(self, index):
        return self.oneseg_vars[index]["eit_mode"]

    def oneseg_eit_event_data(self, index):
        mode = self.oneseg_eit_mode_var(index).get()
        if mode == "main":
            return dict(self.main_eit_values())
        if index == 2 and mode == "oneseg1":
            # OneSeg 2 can keep its own SID while reusing OneSeg 1's EIT contents.
            return dict(self.oneseg_eit_event_data(1))
        return dict(self.oneseg_eit_values(index))

    def oneseg_use_main_eit_var(self, index):
        # Compatibility helper for older code; new code should use oneseg_eit_mode_var().
        return self.oneseg_vars[index]["use_main_eit"]

    def oneseg_eit_var_set(self, index):
        vars_ = self.oneseg_vars[index]
        return {
            "event_id": vars_["event_id"],
            "event_name": vars_["event_name"],
            "event_text": vars_["event_text"],
            "start_time": vars_["start_time"],
            "duration": vars_["duration"],
            "language": vars_["language"],
            "running_status": vars_["running_status"],
            "genre": vars_["genre"],
        }

    def oneseg_pmt_entries(self):
        entries = []
        primary_external = self.has_primary_external_audio()
        secondary_audio = self.has_secondary_audio()
        configs = self.oneseg_encode_configs()

        def audio_components_for(service):
            audio_components = []
            if service.get("shares_oneseg1_audio"):
                return audio_components
            if service["use_main_audio"]:
                if self.primary_use_input_audio.get() == "on" or primary_external:
                    audio_components.append({
                        "kind": "primary",
                        "pid": service["primary_audio_pid"],
                        "component_tag": ONESEG_PRIMARY_AUDIO_COMPONENT_TAG,
                        "language": self.audio_language_code(self.primary_audio_language.get()),
                    })
                if secondary_audio:
                    audio_components.append({
                        "kind": "secondary",
                        "pid": service["secondary_audio_pid"],
                        "component_tag": ONESEG_SECONDARY_AUDIO_COMPONENT_TAG,
                        "language": self.audio_language_code(self.secondary_audio_language.get()),
                    })
            else:
                if service["audio_path"]:
                    audio_components.append({
                        "kind": "primary",
                        "pid": service["primary_audio_pid"],
                        "component_tag": ONESEG_PRIMARY_AUDIO_COMPONENT_TAG,
                ...
                if service["secondary_audio_path"]:
                    audio_components.append({
                        "kind": "secondary",
                        "pid": service["secondary_audio_pid"],
                        "component_tag": ONESEG_SECONDARY_AUDIO_COMPONENT_TAG,
        ...
        audio_components_by_index = {
            service["index"]: audio_components_for(service)
            for service in configs
            if not service.get("shares_oneseg1_audio")
        }

        for pmt_offset, service in enumerate(configs, start=1):
            if service.get("shares_oneseg1_audio"):
                audio_components = audio_components_by_index.get(1, [])
            else:
                audio_components = audio_components_by_index.get(service["index"], [])

            entries.append({
                **service,
                "pmt_pid": ONESEG_PMT_PIDS.get(service["index"], 0x1FC7 + pmt_offset),
                "pcr_pid": ONESEG_PCR_PID,
                "video_component_tag": ONESEG_VIDEO_COMPONENT_TAG,
                "audio_components": audio_components,
            })
        return entries

    def oneseg_eit_component_tag(self, service_id):
        target = self.parse_number(service_id, -1)
        for entry in self.oneseg_pmt_entries():
            if entry["sid_number"] == target:
                return entry["video_component_tag"]
        return "0x00"

    def oneseg_pmt_pid_for_service_id(self, service_id):
        target = self.parse_number(service_id, -1)
        for entry in self.oneseg_pmt_entries():
            if entry["sid_number"] == target:
                return entry["pmt_pid"]
        return None

    def oneseg_encode_configs(self):
        configs = []
        for (
            index,
            sid_var,
            ...
            audio_bitrate_var,
            secondary_audio_bitrate_var,
        ) in self.oneseg_service_rows():
            sid_text = sid_var.get().strip()
            video_mode = video_mode_var.get()
            audio_mode = audio_mode_var.get()
            use_main_video = video_mode == "main"
            use_main_audio = audio_mode == "main"
            video_path = video_var.get().strip()
            if not self.oneseg_is_active(sid_text, video_mode_var, video_var):
                continue
            configs.append({
                "index": index,
                "sid": self.hex_value(sid_text),
                "sid_number": self.parse_number(sid_text, 0),
                "name": name_var.get().strip() or f"{self.service_name.get().strip() or 'OneSeg'}携帯{index}",
                "video_mode": video_mode,
                "audio_mode": audio_mode,
                "use_main_video": use_main_video,
                "video_path": video_path,
                "use_main_audio": use_main_audio,
                "audio_path": audio_var.get().strip(),
                "secondary_audio_path": secondary_audio_var.get().strip(),
                "resolution": resolution_var.get().strip() or ONESEG_SIZE_16_9,
                "video_bitrate": video_bitrate_var.get().strip() or "180k",
                "audio_bitrate": audio_bitrate_var.get().strip() or "48k",
                "secondary_audio_bitrate": secondary_audio_bitrate_var.get().strip() or "48k",
                "video_pid": ONESEG_VIDEO_PIDS.get(index, 0x0281 + ((index - 1) * 0x0100)),
                "primary_audio_pid": ONESEG_PRIMARY_AUDIO_PIDS.get(index, 0x0283 + ((index - 1) * 0x0100)),
                "secondary_audio_pid": ONESEG_SECONDARY_AUDIO_PIDS.get(index, 0x0284 + ((index - 1) * 0x0100)),
                "audio_streams": [],
                "shares_oneseg1_video": False,
                "shares_oneseg1_audio": False,
                "shares_oneseg1_streams": False,
            })

        source = next((service for service in configs if service["index"] == 1), None)
        target = next((service for service in configs if service["index"] == 2), None)
        if target and target["video_mode"] == "oneseg1":
            if source:
                target["shares_oneseg1_video"] = True
                target["video_pid"] = source["video_pid"]
                target["resolution"] = source["resolution"]
                target["video_bitrate"] = source["video_bitrate"]
            else:
                target["video_mode"] = "main"
                target["use_main_video"] = True

        if target and target["audio_mode"] == "oneseg1":
            if source:
                target["shares_oneseg1_audio"] = True
                target["primary_audio_pid"] = source["primary_audio_pid"]
                target["secondary_audio_pid"] = source["secondary_audio_pid"]
                target["audio_bitrate"] = source["audio_bitrate"]
                target["secondary_audio_bitrate"] = source["secondary_audio_bitrate"]
            else:
                target["audio_mode"] = "main"
                target["use_main_audio"] = True

        if target:
            target["shares_oneseg1_streams"] = bool(target.get("shares_oneseg1_video") and target.get("shares_oneseg1_audio"))
            if target.get("shares_oneseg1_video") or target.get("shares_oneseg1_audio"):
                target["shared_from_index"] = 1
    ...
    def ffmpeg_command(self, input_path, output_path, video_info):
        ...
        primary_external = self.has_primary_external_audio()
        secondary_audio = self.has_secondary_audio()
        oneseg_configs = self.oneseg_encode_configs()
        ...
        for service in oneseg_configs:
            if not service.get("shares_oneseg1_video"):
                if service["use_main_video"]:
                    service["video_input_index"] = 0
                else:
                    service["video_input_index"] = next_input
                    cmd.extend(["-i", service["video_path"]])
                    next_input += 1

            service["audio_streams"] = []
            if service.get("shares_oneseg1_audio"):
                continue

            if service["use_main_audio"]:
                if self.primary_use_input_audio.get() == "on":
                    service["audio_streams"].append({
                        "kind": "primary",
                        "map": "0:a:0?",
                        "source_text": "main channel primary audio",
                        "bitrate": service["audio_bitrate"],
                        "channels": {"Mono": "1", "Stereo": "2", "Surround": "2"}.get(self.audio_mode.get(), "2"),
                        "language": self.primary_audio_language.get(),
                        "title": self.track_title(self.primary_audio_title, "Primary Audio"),
                        "pid": service["primary_audio_pid"],
                    })
                elif primary_external:
                    service["audio_streams"].append({
                        "kind": "primary",
                        "map": f"{primary_audio_input}:a:0",
                        "source_text": "main channel primary audio",
                        "bitrate": service["audio_bitrate"],
                        "channels": {"Mono": "1", "Stereo": "2", "Surround": "2"}.get(self.audio_mode.get(), "2"),
                        "language": self.primary_audio_language.get(),
                ...
                if secondary_audio:
                    service["audio_streams"].append({
                        "kind": "secondary",
                        "map": f"{secondary_audio_input}:a:0",
                        "source_text": "main channel secondary audio",
                        "bitrate": service["secondary_audio_bitrate"],
                        "channels": self.secondary_audio_channels(),
                        "language": self.secondary_audio_language.get(),
                        "title": self.track_title(self.secondary_audio_title, "Secondary Audio"),
                        "pid": service["secondary_audio_pid"],
                    })
            else:
                if service["audio_path"]:
                    service["audio_streams"].append({
                        ...
                        "source_text": service["audio_path"],
                        "bitrate": service["audio_bitrate"],
                        "channels": "2",
                        "language": "Japanese (jpn)",
                        "title": f"OneSeg {service['index']} Primary Audio",
                        "pid": service["primary_audio_pid"],
                    })
                    cmd.extend(["-i", service["audio_path"]])
                    next_input += 1
                ...
                if service["secondary_audio_path"]:
                    service["audio_streams"].append({
                        "kind": "secondary",
                        "map": f"{next_input}:a:0",
                        "source_text": service["secondary_audio_path"],
                        "bitrate": service["secondary_audio_bitrate"],
                        "channels": "2",
                        "language": "English (eng)",
                        "title": f"OneSeg {service['index']} Secondary Audio",
                        "pid": service["secondary_audio_pid"],
                    })
                    cmd.extend(["-i", service["secondary_audio_path"]])
                    next_input += 1

        output_stream_index = 0
        main_program_streams = []
        cmd.extend(["-map", "0:v:0"])
        main_program_streams.append(output_stream_index)
        ...
        for service in oneseg_configs:
            source = next((item for item in oneseg_configs if item["index"] == service.get("shared_from_index", 1)), None)
            if service.get("shares_oneseg1_video") and source is not None:
                service["out_video_stream_index"] = source.get("out_video_stream_index")
            else:
                cmd.extend(["-map", f"{service['video_input_index']}:v:0"])
                service["out_video_stream_index"] = output_stream_index
                output_stream_index += 1

            if service.get("shares_oneseg1_audio") and source is not None:
                service["audio_streams"] = source.get("audio_streams", [])
            else:
                for audio_stream in service["audio_streams"]:
                    cmd.extend(["-map", audio_stream["map"]])
                    audio_stream["out_stream_index"] = output_stream_index
                    output_stream_index += 1

        cmd.extend([
            "-filter:v:0", self.video_filter(video_info),
            "-c:v:0", "mpeg2video",
            "-b:v:0", self.video_bitrate.get().strip() or "13M",
            "-maxrate:v:0", self.video_maxrate.get().strip() or "14M",
            "-bufsize:v:0", self.video_bufsize.get().strip() or "8M",
            "-g:v:0", self.gop.get().strip() or "15",
            "-bf:v:0", "2",
            "-pix_fmt:v:0", "yuv420p",
        ])

        if self.scan_mode.get() == "60i":
            cmd.extend(["-flags:v:0", "+ildct+ilme", "-r:v:0", "30000/1001"])
        else:
        ...
        for service in oneseg_configs:
            ...
            service_video_info = video_info if service["use_main_video"] else self.probe_video_info(service["video_path"])
            bitrate = service["video_bitrate"]
            cmd.extend([
                f"-filter:v:{video_stream_index}", self.oneseg_video_filter(service_video_info, service["resolution"]),
                f"-c:v:{video_stream_index}", "libx264",
                f"-profile:v:{video_stream_index}", "baseline",
                f"-level:v:{video_stream_index}", "1.2",
                f"-b:v:{video_stream_index}", bitrate,
                f"-maxrate:v:{video_stream_index}", self.scaled_bitrate(bitrate, 1.25, "220k"),
                f"-bufsize:v:{video_stream_index}", self.scaled_bitrate(bitrate, 2.1, "384k"),
                f"-g:v:{video_stream_index}", "15",
                f"-bf:v:{video_stream_index}", "0",
                f"-pix_fmt:v:{video_stream_index}", "yuv420p",
                f"-r:v:{video_stream_index}", "15",
            ])
            video_stream_index += 1
        ...
        if self.is_ts_info_enabled():
            cmd.extend([
                ...
                "-mpegts_pmt_start_pid", "0x1FC7",
                "-mpegts_service_id", str(self.parse_number(self.service_id_1.get(), 1)),
        ...
        if self.is_ts_info_enabled():
            program_args = [
                f"program_num={self.parse_number(self.service_id_1.get(), 1)}",
                *[f"st={stream_index}" for stream_index in main_program_streams],
            ]
            cmd.extend(["-program", ":".join(program_args)])

            for service in oneseg_configs:
                program_args = [
                    f"program_num={service['sid_number']}",
                    f"st={service['out_video_stream_index']}",
                    *[f"st={audio_stream['out_stream_index']}" for audio_stream in service["audio_streams"] if "out_stream_index" in audio_stream],
                ]
                cmd.extend(["-program", ":".join(program_args)])

        cmd.extend(["-streamid", f"0:0x{MAIN_VIDEO_PID:04X}"])

        for service in oneseg_configs:
            if not service.get("shares_oneseg1_video"):
                cmd.extend(["-streamid", f"{service['out_video_stream_index']}:0x{service['video_pid']:04X}"])
            if not service.get("shares_oneseg1_audio"):
                for audio_stream in service["audio_streams"]:
                    cmd.extend(["-streamid", f"{audio_stream['out_stream_index']}:0x{audio_stream['pid']:04X}"])
    ...
    def ts_xml_values(self):
        ...
        return {
            ...
            "oneseg_service_id": self.hex_value(self.oneseg_service_id_1.get()),
    ...
    def write_tsduck_xml_files(self, base_name):
        ...
        full_service_ids = self.service_ids()
        full_service_names = [
        ...
        oneseg_entries = self.oneseg_sid_entries()
        ...
        for service_id, service_name, service_type, user_defined, eit_schedule in [
            (full_service_ids[0], full_service_names[0], "0x01", "4", "true"),
            (full_service_ids[1], full_service_names[1], "0x01", "4", "true"),
            (full_service_ids[2], full_service_names[2], "0x01", "4", "true"),
        ]:
            sdt_lines.extend([
        ...
        for entry in oneseg_entries:
            sdt_lines.extend([
                f'    <service service_id="{entry["sid"]}" EIT_schedule="false" EIT_present_following="true" CA_mode="false" running_status="undefined">',
                f'      <service_descriptor service_type="0xC0" service_provider_name="{provider}" service_name="{xml_escape(entry["name"])}"/>',
                '      <digital_copy_control_descriptor digital_recording_control_data="2" user_defined="11"/>',
                "    </service>",
            ])
        sdt_lines.extend(["  </SDT>", "</tsduck>", ""])

        nit_lines = self.nit_xml_lines(values, full_service_ids, oneseg_entries)
        self.write_temp_xml(sdt_path, sdt_lines)
        self.write_temp_xml(nit_path, nit_lines)
        return sdt_path, nit_path

    def service_ids(self):
        base = self.parse_number(self.service_id_1.get(), 0x6238)
        defaults = [base, base + 1, base + 2]
        variables = [self.service_id_1, self.service_id_2, self.service_id_3]
        return [f"0x{self.parse_number(variable.get(), defaults[index]):04X}" for index, variable in enumerate(variables)]

    def nit_xml_lines(self, values, service_ids, oneseg_entries):
        service_list_lines = [
        ...
        for entry in oneseg_entries:
            service_list_lines.append(f'        <service service_id="{entry["sid"]}" service_type="0xC0"/>')
        ...
        if oneseg_entries:
            lines.append("      <partial_reception_descriptor>")
            for entry in oneseg_entries:
                lines.append(f'        <service id="{entry["sid"]}"/>')
            lines.append("      </partial_reception_descriptor>")
        ...
        if oneseg_entries:
            lines.append('        <transmission_type transmission_type_info="0xAF">')
            for entry in oneseg_entries:
                lines.append(f'          <service id="{entry["sid"]}"/>')
            lines.append("        </transmission_type>")
    ...
    def get_oneseg_event_description(self, index):
        text_widget = getattr(self, "oneseg_description_texts", {}).get(index)
        if text_widget is not None:
            return text_widget.get("1.0", "end-1c").strip()
        return self.oneseg_eit_var_set(index)["event_text"].get().strip()

    def genre_nibbles_from_value(self, value):
        match = re.search(r"\((0x[0-9A-Fa-f]+)/(0x[0-9A-Fa-f]+)\)", str(value))
        return match.groups() if match else ("0x0", "0x0")

    def main_eit_values(self):
        return {
            "event_id": self.event_id.get(),
            "event_name": self.event_name.get(),
            "text": self.get_event_description(),
            "start_time": self.event_start_time.get(),
            "duration": self.event_duration.get(),
            "language": self.event_language.get(),
            "running_status": self.event_running_status.get(),
            "genre": self.genre.get(),
        }

    def oneseg_eit_values(self, index):
        values = self.oneseg_eit_var_set(index)
        return {
            "event_id": values["event_id"].get(),
            "event_name": values["event_name"].get(),
            "text": self.get_oneseg_event_description(index),
            "start_time": values["start_time"].get(),
            "duration": values["duration"].get(),
            "language": values["language"].get(),
            "running_status": values["running_status"].get(),
            "genre": values["genre"].get(),
        }

    def eit_section_lines(self, service_id, component_tag="0x00", event_data=None):
        values = self.ts_xml_values()
        data = event_data or self.main_eit_values()
        content_l1, content_l2 = self.genre_nibbles_from_value(data.get("genre", self.genre.get()))
        language_code = self.audio_language_code(data.get("language", self.event_language.get()))
        return [
            f'  <EIT type="pf" version="0" current="true" actual="true" service_id="{service_id}" transport_stream_id="{values["transport_stream_id"]}" original_network_id="{values["original_network_id"]}" last_table_id="0x4E">',
            '    <metadata PID="18"/>',
            f'    <event event_id="{self.hex_value(data.get("event_id", self.event_id.get()))}" start_time="{self.normalize_eit_datetime(data.get("start_time", self.event_start_time.get()))}" duration="{str(data.get("duration", self.event_duration.get())).strip() or "00:15:00"}" running_status="{str(data.get("running_status", self.event_running_status.get())).strip() or "running"}" CA_mode="false">',
            f'      <short_event_descriptor language_code="{language_code}">',
            f"        <event_name>{xml_escape(str(data.get('event_name', '')).strip() or 'Program')}</event_name>",
            f"        <text>{xml_escape(str(data.get('text', '')).strip())}</text>",
            "      </short_event_descriptor>",
            f'      <component_descriptor stream_content="0x01" stream_content_ext="0x0F" component_type="0xB3" component_tag="{component_tag}" language_code="{language_code}" text=""/>',
            "      <content_descriptor>",
    ...
    def oneseg_pmt_xml_lines(self, entry):
        lines = [
            '<?xml version="1.0" encoding="UTF-8"?>',
            "<tsduck>",
            f'  <PMT version="0" current="true" service_id="{entry["sid"]}" PCR_PID="0x{entry.get("pcr_pid", entry["video_pid"]):04X}">',
            f'    <metadata PID="0x{entry["pmt_pid"]:04X}"/>',
            f'    <component elementary_PID="0x{entry["video_pid"]:04X}" stream_type="0x1B">',
            f'      <stream_identifier_descriptor component_tag="{entry["video_component_tag"]}"/>',
            "    </component>",
        ]

        for audio in entry["audio_components"]:
            lines.extend([
                f'    <component elementary_PID="0x{audio["pid"]:04X}" stream_type="0x0F">',
                f'      <stream_identifier_descriptor component_tag="{audio["component_tag"]}"/>',
                "      <ISO_639_language_descriptor>",
                f'        <language code="{audio["language"]}" audio_type="0x00"/>',
                "      </ISO_639_language_descriptor>",
                "    </component>",
            ])
    ...
    def write_oneseg_pmt_xml_files(self, base_name):
        files = []
        for entry in self.oneseg_pmt_entries():
            path = os.path.join(tempfile.gettempdir(), f"{base_name}_oneseg{entry['index']}_pmt.xml")
            self.write_temp_xml(path, self.oneseg_pmt_xml_lines(entry))
            files.append({
                "path": path,
                "pid": entry["pmt_pid"],
                "pid_hex": f"0x{entry['pmt_pid']:04X}",
                "pcr_pid": entry.get("pcr_pid", entry["video_pid"]),
                "pcr_pid_hex": f"0x{entry.get('pcr_pid', entry['video_pid']):04X}",
                "index": entry["index"],
                "sid": entry["sid"],
            })
        return files
    ...
    def write_program_xml_files(self, base_name):
        ...
        eit_lines = [
            '<?xml version="1.0" encoding="UTF-8"?>',
            "<tsduck>",
            *self.eit_section_lines(self.service_ids()[0]),
        ]

        for entry in self.oneseg_eit_entries():
            eit_lines.extend(self.eit_section_lines(
                entry["sid"],
                self.oneseg_eit_component_tag(entry["sid"]),
                entry.get("event_data"),
            ))

        eit_lines.extend(["</tsduck>", ""])
    ...
    def tsduck_command(self, input_path, output_path, sdt_path, nit_path, cat_path=None, pmt_files=None, eit_path=None, time_path=None):
        ...
        for pmt in pmt_files or []:
            cmd.extend(["-P", "inject", pmt["path"], "--japan", "--pid", pmt["pid_hex"], "--replace"])
        ...
        if self.eit_enabled.get() == "on" and eit_path:
            cmd.extend(["-P", "inject", eit_path, "--japan", "--stuffing", "--pid", "0x0012", "--bitrate", "50000"])
    ...
    def encode_one_file(self, input_path, file_index=1, total_files=1):
        ...
        if self.is_ts_info_enabled():
            if self.oneseg_encode_configs():
                self.inject_pcr_only_pid(ffmpeg_output)
            return self.run_tsduck(base, ffmpeg_output, final_output)

        self.log_queue.put("\nDone\n")
        return True

    def current_muxrate_bps(self):
        return 8_000_000 if self.is_sd_output_size() else 16_000_000

    @staticmethod
    def ts_packet_pid(packet):
        if len(packet) != 188 or packet[0] != 0x47:
            return None
        return ((packet[1] & 0x1F) << 8) | packet[2]

    @staticmethod
    def make_pcr_only_packet(pid, continuity_counter, pcr_base, pcr_ext=0):
        pcr_base &= (1 << 33) - 1
        pcr_ext &= 0x1FF
        return bytes([
            0x47,
    ...
    def inject_pcr_only_pid(self, ts_path, pcr_pid=ONESEG_PCR_PID, period_ms=ONESEG_PCR_PERIOD_MS):
        if not os.path.exists(ts_path):
            return 0

        packet_size = 188
        muxrate_bps = self.current_muxrate_bps()
        packets_per_second = muxrate_bps / (packet_size * 8)
        interval_packets = max(1, int(round(packets_per_second * period_ms / 1000)))
        temp_path = ts_path + ".pcrtmp"
        next_pcr_packet = 0
        continuity_counter = 0
        packet_index = 0
        injected = 0

        with open(ts_path, "rb") as source, open(temp_path, "wb") as target:
            while True:
                ...
                pid = self.ts_packet_pid(packet)
                if pid == 0x1FFF and packet_index >= next_pcr_packet:
                    pcr_base = int(round((packet_index / packets_per_second) * 90_000))
                    target.write(self.make_pcr_only_packet(pcr_pid, continuity_counter, pcr_base))
                    # Adaptation-field-only packets do not carry payload, so the
                    # continuity counter is intentionally kept unchanged.
                    injected += 1
                    while next_pcr_packet <= packet_index:
                        next_pcr_packet += interval_packets
                else:
                    target.write(packet)

                packet_index += 1

        os.replace(temp_path, ts_path)
        self.log_queue.put(
            f"OneSeg PCR-only PID: injected {injected} packets on PID 0x{pcr_pid:04X} "
            f"/ period {period_ms} ms / muxrate {muxrate_bps // 1000}k\n"
        )
        if injected == 0:
            self.log_queue.put(
                "Warning: no null packets were available for PCR-only PID injection. "
                "OneSeg PMT PCR_PID may point to an empty PID.\n"
            )
        return injected
    ...
    def run_tsduck(self, base, ffmpeg_output, final_output):
        ...
        pmt_files = self.write_oneseg_pmt_xml_files(base)
        ...
        cmd = self.tsduck_command(ffmpeg_output, final_output, sdt_path, nit_path, cat_path, pmt_files, eit_path, time_path)
        self.log_tsduck_files(cmd, sdt_path, nit_path, cat_path, pmt_files, eit_path, time_path)
    ...
    def log_encode_settings(self, input_path, output_path, video_info, cmd):
        ...
        self.log_queue.put(
            ...
            f"decision={src.get('decision', 'metadata/fallback')}\n"
        )
        self.log_queue.put(
            f"Output color: {dst['label']} matrix={dst['matrix_z']}, "
            f"primaries={dst['primaries_z']}, transfer={dst['transfer_z']}\n"
        )
        self.log_queue.put(f"Color process: {self.color_process_label(video_info)}\n")
        ...
        if self.is_sd_sidecut_size():
            in_w = int(video_info.get("width") or 0)
            in_h = int(video_info.get("height") or 0)
            if (in_w, in_h) != (1920, 1080):
                self.log_queue.put(
                    f"Warning: 720x480 side-cut mode is designed for 1920x1080 input. "
                    f"Detected {in_w or 'unknown'}x{in_h or 'unknown'}.\n"
                )

        primary_source = "input audio" if self.primary_use_input_audio.get() == "on" else (self.primary_audio_path.get().strip() or "none")
        self.log_queue.put(f"Main video PID: 0x{MAIN_VIDEO_PID:04X}\n")
        ...
        for service in oneseg_configs:
            if service.get("shares_oneseg1_video"):
                video_text = "shared from OneSeg 1"
            else:
                video_text = "main channel video" if service["use_main_video"] else service["video_path"]

            if service.get("shares_oneseg1_audio"):
                audio_text = "shared from OneSeg 1"
            elif service.get("use_main_audio"):
                audio_text = "main channel audio; secondary is included when the main channel has secondary audio"
            else:
                primary_text = service["audio_path"] or "none"
                secondary_text = service["secondary_audio_path"] or "none"
                audio_text = f"primary={primary_text}, secondary={secondary_text}"

            self.log_queue.put(
                f"OneSeg {service['index']}: SID={service['sid']} / video={video_text} / "
                f"audio={audio_text} / H.264 Baseline L1.2 / {service['resolution']} / "
                f"video bitrate {service['video_bitrate']} / AAC-LC primary {service['audio_bitrate']} / "
                f"secondary {service['secondary_audio_bitrate']} / "
                f"PID video=0x{service['video_pid']:04X}, PCR-only=0x{ONESEG_PCR_PID:04X}, "
                f"primary audio=0x{service['primary_audio_pid']:04X}, "
                f"secondary audio=0x{service['secondary_audio_pid']:04X}\n"
            )

        for index, sid_var, _name_var, video_mode_var, video_var, _audio_mode_var, _audio_var, _secondary_audio_var, _resolution_var, _video_bitrate_var, _audio_bitrate_var, _secondary_audio_bitrate_var in self.oneseg_service_rows():
            if sid_var.get().strip() and video_mode_var.get() == "custom" and not video_var.get().strip():
                self.log_queue.put(f"OneSeg {index}: SID is set, but OneSeg video is blank and custom OneSeg video is selected. This OneSeg service will not be added.\n")

        if self.is_sd_sidecut_size():
            self.log_queue.put("SD side-cut process: crop 1920x1080 center to 1440x1080 by cutting L/R 240px -> blacken L/R 15px -> scale 720x486 -> crop 720x480\nMuxrate: 8000k\n")
        elif self.is_sd_output_size():
    ...
    def log_tsduck_files(self, cmd, sdt_path, nit_path, cat_path, pmt_files, eit_path, time_path):
        self.log_queue.put("\nTSDuck XML:\n")
        if cat_path:
            self.log_queue.put(f"CAT: {cat_path}\n")
        for pmt in pmt_files or []:
            self.log_queue.put(f"PMT OneSeg {pmt['index']}: {pmt['path']} / PID={pmt['pid_hex']} / PCR={pmt.get('pcr_pid_hex', 'unknown')} / SID={pmt['sid']}\n")
        self.log_queue.put(f"SDT: {sdt_path}\n")
        self.log_queue.put(f"NIT: {nit_path}\n")
        if eit_path:
            self.log_queue.put(f"EIT: {eit_path} / stuffing injection / bitrate=50000\n")
            oneseg_eit_count = len(self.oneseg_eit_entries())
            if oneseg_eit_count:
                self.log_queue.put(f"EIT: includes main service and {oneseg_eit_count} active OneSeg service(s)\n")
        if time_path:
